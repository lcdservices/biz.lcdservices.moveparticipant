...
class CRM_LCD_MoveParticipant_Form_MoveParticipant extends CRM_Core_Form {
  ...
  public function buildQuickForm() {
    ...
    $this->_contactId = civicrm_api3('participant', 'getvalue', [
    ...
    $this->add('hidden', 'participant_id', $this->_participantId, ['id' => 'participant_id']);
    $this->add('hidden', 'current_contact_id', $this->_contactId, ['id' => 'current_contact_id']);
