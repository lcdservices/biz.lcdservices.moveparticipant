 ...
 */
class CRM_LCD_MoveParticipant_Upgrader_Base {
  ...
  static public function instance() {
    if (! self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_LCD_MoveParticipant_Upgrader(
        'biz.lcdservices.moveparticipant',
        realpath(__DIR__ .'/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_LCD_MoveParticipant_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
